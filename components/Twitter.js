  ...
  return (
    ...
    >
      <svg
        ...
        height="25"
        viewBox="0 0 48 48"
        style={{ fill: "#000000", display: "inline", marginRight: "2px" }}
      >
        <linearGradient
        ...
        <path
          className="fill-[#222] dark:fill-[#ddd]"
      ...
      <span className="align-middle font-bold text-blue-500 hover:text-blue-600">
        @{username}
      </span>
    </a>
  );
